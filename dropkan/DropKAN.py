...
class DropKAN(nn.Module):
    ...
    def fit(self, dataset, opt="LBFGS", steps=100, log=1, lamb=0., lamb_l1=1., lamb_entropy=0., lamb_coef=0., lamb_coefdiff=0., update_grid=False, grid_update_num=10, loss_fn=None, lr=1., stop_grid_update_step=50, batch=-1,
